...
All tests were done between 10 and 12 in the morning when the lizards werew most active. Each trial was performed daily for five days, between the 17^th^ to the 22^nd^ of May 2024. After the tests, videos were analysed to record: a) the first choice of the lizard (1 if it was the higher number, 0 if not), b) the latency, or time spent by the lizard to make a choice, c) the time spent close to a choice after five minutes of perceiving it, and d) the number of attacks towards a choice for 5 min after perceiving it. We considered a choice when the lizard touched the Petri dish with its snout, by then, we considered that the choice had been perceived. Finally, we considered an attack when the lizard tried to bite the Petri dish.  
