...
csl: "./bib/evolutionary-ecology.csl"
execute:
  echo: false
  error: false
  cache: false
...
## Data accessibility  
All data, data description, and R code are available in public repository [https://github.com/Pablo-Recio/CORT-Temp_Numerical](https://github.com/Pablo-Recio/CORT-Temp_Numerical). Data is also available at [Dryad](https://doi.org/10.5061/dryad.08kprr5gv)
...
_Table S3A.- Summary of the model fitted for loglatency (Latency). q5 and q95 show the lowest and highest values of standard 95% credible intervals, while in the text we report 95% HDPI_
...
_Table S3B.- Summary of the model fitted for Choice. q5 and q95 show the lowest and highest values of standard 95% credible intervals, while in the text we report 95% HDPI_   
...
_Table S3C.- Summary of the model fitted for Interest. q5 and q95 show the lowest and highest values of standard 95% credible intervals, while in the text we report 95% HDPI_  
```{r, tbl-summary_int}
...
_Table S3D.- Summary of the model fitted for other effects. q5 and q95 show the lowest and highest values of standard 95% credible intervals, while in the text we report 95% HDPI_  
```{r, tbl-summary_other}
